...
```
  ...
  * [libmy.a](./libmy.a): My static library containing C functions
  * [main.h](./main.h)
...
```
  ...
  * [create_static_lib.sh](./create_static_lib.sh): a script called create_static_lib.sh that creates a static library called 
