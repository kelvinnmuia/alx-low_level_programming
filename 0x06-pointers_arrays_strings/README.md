...
The project introduced me to more Pointers, Arrays and Strings in C programming language.
...
```
  ...
  * [0-strcat.c](./0-strcat.c): A C function that concatenates two strings.
...
```
  ...
  * [1-strncat.c](./1-strncat.c): A C function that concatenates two strings.
...
```
  ...
  * [2-strncpy.c](./2-strncpy.c): A C function that copies a string.
...
```
  ...
  * [3-strcmp.c](./3-strcmp.c): A C function that compares two strings.
...
```
  ...
  * [4-rev_array.c](./4-rev_array.c): A C function that reverses the content of an array of integers.
...
```
  ...
  * [5-string_toupper.c](./5-string_toupper.c): A C function that changes all lowercase letters of a string to uppercase.
...
```
  ...
  * [6-cap_string.c](./6-cap_string.c): A C function that capitalizes all words of a string.
...
```
  ...
  * [7-leet.c](./7-leet.c): A C function that encodes a string into 1337.
...
```
  ...
  * [100-rot13.c](./100-rot13.c): A C function that encodes a string using rot13.
...
Add one line to this code, so that the program prints `a[2] = 98`, followed by a new line.
  ...
  * [102-magic.c](./102-magic.c): A C program prints `a[2] = 98`, followed by a new line.
...
```
  ...
  * [103-infinite_add.c](./103-infinite_add.c): A C function that adds two numbers.
...
```
  ...
  * [104-print_buffer.c](./104-print_buffer.c): A C function that prints a buffer.

##  0x06. C - More pointers, arrays and strings

  * [0x06.C-More-pointers-arrays-and-strings](https://drive.google.com/file/d/1tNXBj_mgRuiR6AYjMTJ_zcMMyDHCf5qC/view?usp=drive_link)
