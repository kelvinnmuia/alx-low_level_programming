...
```
  ...
  * [0-memset.c](./0-memset.c): A C function that fills memory with a constant byte.
...
```
  ...
  * [1-memcpy.c](./1-memcpy.c): A C function that copies memory area.
...
```
  ...
  * [2-strchr.c](./2-strchr.c): A C function that locates a character in a string.
...
```
  ...
  * [3-strspn.c](./3-strspn.c): A C function that gets the length of a prefix substring.
...
```
  ...
  * [4-strpbrk.c](./4-strpbrk.c): A C function that searches a string for any of a set of bytes.
...
```
  ...
  * [5-strstr.c](./5-strstr.c): A C function that locates a substring.
...
```
  ...
  * [7-print_chessboard.c](./7-print_chessboard.c):  A C function that prints the chessboard.
...
```
  ...
  * [8-print_diagsums.c](./8-print_diagsums.c): A C function that prints the sum of the two diagonals of a square matrix of integers.
...
```
  ...
  * [100-set_string.c](./100-set_string.c): A C function that sets the value of a pointer to a char.
...
##  0x07. C - Even more pointers, arrays and strings 
  ...
  * [0x07-C-Even-more-pointers-arrays-and-strings](https://drive.google.com/file/d/1O-jBbD6G6zyvjA4fRjDGoVtAbeWQnoX6/view?usp=drive_link)
