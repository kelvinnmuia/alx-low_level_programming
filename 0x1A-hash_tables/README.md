...
better understand the power and simplicity of Python dictionaries. So much is actually happening when you type 
d = {'a': 1, 'b': 2}, but everything looks so simple for the user. Python doesn’t use the exact same implementation 
than the one you will work on today though. If you are curious on how it works under the hood, here is a good blog post 
about how dictionaries are implemented in Python 2.7 (not mandatory).
...
```
  ...
  * [0-hash_table_create.c](./0-hash_table_create.c): A C function that creates a hash table.
...
```
  ...
  * [2-key_index.c](./2-key_index.c): A C function that gives you the index of a key.
...
If you want to test for collisions, here are some strings that collide using the djb2 algorithm:
  ...
  * [3-hash_table_set.c](./3-hash_table_set.c): A C function that adds an element to the hash table.
...
```
  ...
  * [4-hash_table_get.c](./4-hash_table_get.c): A C function that retrieves a value associated with a key.
...
```
  ...
  * [5-hash_table_print.c](./5-hash_table_print.c): A C function that prints a hash table.
...
```
  ...
  * [6-hash_table_delete.c](./6-hash_table_delete.c): A C function that deletes a hash table.
