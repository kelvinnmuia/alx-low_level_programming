...
## The Domains/Concepts covered in this project: `C programming` `Algorithm` `Data structure`
 ...
 The project introduced me to Doubly linked lists
...
```
  ...
  * [0-print_dlistint.c](./0-print_dlistint.c): A C function that prints all the elements of a dlistint_t list.
...
```
  ...
  * [1-dlistint_len.c](./1-dlistint_len.c): A C function that returns the number of elements in a linked dlistint_t list.
...
```
  ...
  * [2-add_dnodeint.c](./2-add_dnodeint.c): A C function that adds a new node at the beginning of a dlistint_t list.
...
```
  ...
  * [3-add_dnodeint_end.c](./3-add_dnodeint_end.c): A C function that adds a new node at the end of a dlistint_t list.
...
```
  ...
  * [4-free_dlistint.c](./4-free_dlistint.c): A C function that frees a dlistint_t list.
...
```
  ...
  * [5-get_dnodeint.c](./5-get_dnodeint.c): A C function that returns the nth node of a dlistint_t linked list.
...
```
  ...
  * [6-sum_dlistint.c](./6-sum_dlistint.c): A C function that returns the sum of all the data (n) of a dlistint_t linked list.
...
```
  ...
  * [8-delete_dnodeint.c](./8-delete_dnodeint.c): A C function that deletes the node at index index of a dlistint_t linked list.
...
Find the password for crackme4.
  ...
  * [100-password](./100-password):  A C program for cracking passwords
...
Find the largest palindrome made from the product of two 3-digit numbers.
  ...
  * [102-result](./102-result): A C program that finds and saves the largest palindrome made from the product of two 2-digit numbers is 9009 = 91 × 99.
...
```
  ...
  * [103-keygen.c](./103-keygen.c): A keygen for the crackme5.

## 0x17. C - Doubly linked lists

  * [0x17-C-Doubly-linked-lists](https://drive.google.com/file/d/1VC_Q-DnQu0xB2qbR3w5CwTeFg9h_koRd/view?usp=drive_link)
