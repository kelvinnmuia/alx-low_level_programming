...
```
  ...
  * [0-read_textfile.c](./0-read_textfile.c): A C function that reads a text file and prints it to the POSIX standard output.
...
```
  ...
  * [1-create_file.c](./1-create_file.c): A C function that creates a file.
...
```
  ...
  * [2-append_text_to_file.c](./2-append_text_to_file.c): A C function that appends text at the end of a file.
...
```
  ...
  * [3-cp.c](./3-cp.c): A C program that copies the content of a file to another file.
...
```
  ...
  * [100-elf_header.c](./100-elf_header.c): A C program that displays the information contained in the ELF header at the start of an ELF file.


## 0x15. C - File I/O

  * [0x15-C-File-I/O](https://drive.google.com/file/d/1GHzvD8j40NHtX8mNDT9DR2hsSpmlu-zR/view?usp=drive_link)
