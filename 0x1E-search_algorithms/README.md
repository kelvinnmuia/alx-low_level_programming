...
## The Domains/Concepts covered in this project: `C programming` `Algorithm`

 The project introduced me to search algorithms in C programming language.
...
```
  ...
  * [0-linear.c](./0-linear.c): A C function that searches for a value in an array of integers using the Linear search algorithm.
...
```
  ...
  * [1-binary.c](./1-binary.c): A C function that searches for a value in a sorted array of integers using the Binary search algorithm.
...
```
  ...
  * [100-jump.c](./100-jump.c): A C function that searches for a value in a sorted array of integers using the Jump search algorithm.
...
```
  ...
  * [102-interpolation.c](./102-interpolation.c): A C function that searches for a value in a sorted array of integers using the Interpolation search algorithm.
...
```
  ...
  * [103-exponential.c](./103-exponential.c) A C function that searches for a value in a sorted array of integers using the Exponential search algorithm.
...
```
  ...
  * [104-advanced_binary.c](./104-advanced_binary.c) A C function that searches for a value in a sorted array of integers.
...
```
  ...
  * [105-jump_list.c](./105-jump_list.c): A C function that searches for a value in a sorted list of integers using the Jump search algorithm.
...
```
  ...
  * [106-linear_skip.c](./106-linear_skip.c): A C function that searches for a value in a sorted skip list of integers.
