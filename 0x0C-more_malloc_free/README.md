...
```
  ...
  * [0-malloc_checked.c](./0-malloc_checked.c): A C function that allocates memory using malloc.
...
```
  ...
  * [1-string_nconcat.c](./1-string_nconcat.c): A C function that concatenates two strings.
...
```
  ...
  * [2-calloc.c](./2-calloc.c): A C function that allocates memory for an array, using `malloc`.
...
```
  ...
  * [3-array_range.c](./3-array_range.c):  A C function that creates an array of integers.
...
```
  ...
  * [100-realloc.c](./100-realloc.c): A C function that reallocates a memory block using malloc and free.
...
```
  ...
  * [101-mul.c](./101-mul.c): A C program that multiplies two positive numbers.

##  0x0C. C - More malloc, free

  * [0x0C. C - More malloc, free](https://drive.google.com/file/d/1bNE-pBVeWGksw4X6bkgXFQgRBm9NdYMG/view?usp=sharing)
